...
<p><em>Database</em></p>
<p>We will be using phpmyadmin as the database.</p>
...
This is how this application is profitable for all of seller, buyer and developer.

This profit section i could not do it due to some problem.<p/>
