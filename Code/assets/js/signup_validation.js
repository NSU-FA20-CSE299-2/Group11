...
if ( illegalChars.test(name)) {
  ...
  document.getElementById('name_error').style.fontSize = "12px";
  document.getElementById('name_error').style.color = "red";
  document.getElementById('name_error').innerHTML = "Name contain only alphabet!" ;
...
if(password != repassword ){
  error++;
  document.getElementById('repassword_error').style.fontSize = "12px";
  document.getElementById('repassword_error').style.color = "red";
